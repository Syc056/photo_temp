...
//     //         // const latestImage = photos.images[photos.images.length - 1];
//     //         const latestImage = photos.images[photos.images.length - 1];
//     //         // const latestImage = photos.images.sort((a,b)=>{
//     //         //     const formatA=formatDateTime(a.url&&a.url.split("uploads/")[1])
//     //         //     const formatB=formatDateTime(b.url&&b.url.split("uploads/")[1])
//     //         //     const dateA = convertToDate(formatA);
//     //         //     const dateB =convertToDate(formatB);
//     //         //     return dateA-dateB

//     //         // })
//     //         console.log("before imageName>>>",latestImage)
//     //         const imageName = latestImage.url.split('/').pop();
//     //         const formattedImage = {
//     //             ...latestImage,
//     //             url: `${process.env.REACT_APP_BACKEND}/serve_photo/${imageName}`
//     //         };
//     //         console.log("Latest photo", photos.images.length, formattedImage.url.replace(/\\/g, '/').replace('serve_photo', 'get_photo/uploads'));
...
//     useEffect(() => {
//         ///uuid create
//     //    const newUuid =sessionStorage.setItem("uuid",Uid().toString())
//     const uuid=Uid()
//        setUuid(uuid)
