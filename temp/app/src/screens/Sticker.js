...
const addStickerToPanel = ({ bgIdx, src, width, x, y }) => {
    ...
    //                             test = sessionStorage.getItem('uploadedCloudPhotoUrl');
    //                             console.log("etsstastetse>>",test)
...
//         //console.log("uuid blob>>>",uuidBlob)
//         formData.append("photo", newFile);
        
//         formData.append("uuid",json);
...
//     console.log('upload url>>>',uploadsDataPath,res.images)
...
// const removeIdx=4;
// splittedUrl.splice(removeIdx,1)
// newUrl=splittedUrl.join("/")
// return newUrl
//     }
const convertUrl = (url) => {
...
const updateStickerPositionAndSize = (index, newX, newY, newWidth, newHeight) => {
    ...
    const getCarouselStyle=(selFrame)=>{
        //  return "77%"
        if (selFrame==="Stripx2") {
            return {height:"80%",bottom:"18%",right:"12%"}
        }
